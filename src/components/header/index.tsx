...
import { ThemeSelect, ThemeToggle } from '@components/theme';
import Skill from '@utils/models/skill';
import TopDownSkillMenu from '@components/question-bank/menu/top-down';
...
export const NavPopover: React.FC<{ display: string; className: string }> = ({
  display = 'md:hidden',
  className,
  ...props
}) => {
  ...
  return (
    <div className={`${className} ${display}`} {...props}>
      <button
        type="button"
      ...
      <Dialog as="div" className={`fixed z-50 inset-0 ${display}`} open={isOpen} onClose={setIsOpen}>
...
export const NavItems: React.FC = () => {
  return (
    <>
      <li>
        <a href="/docs/about" className="hover:text-sky-500 dark:hover:text-sky-400">
          About
        </a>
      </li>
      <li>
        <Link href="/questions">
          <a className="hover:text-sky-500 dark:hover:text-sky-400">All Questions</a>
        </Link>
      </li>
      <li>
        <Link href="/">
          <a className="hover:text-sky-500 dark:hover:text-sky-400">Skills</a>
        </Link>
      </li>
    </>
  );
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header
      className={`relative sticky top-0 z-40 w-full backdrop-blur flex-none transition-colors duration-500 lg:z-50 lg:border-b lg:border-slate-900/10 dark:border-slate-50/[0.06] ${
        isOpaque
          ...
          >
            <div className="relative flex items-center">
              <Link href="/">
                ...
                >
                  <span className="sr-only">QB - Home page</span>
              ...
              <div
                className={`ml-auto text-slate-500 w-8 h-8 -my-1 flex items-center justify-center
               hover:text-slate-600 lg:hidden dark:text-slate-400 dark:hover:text-slate-300`}
              >
